...
Deux étudiants à la session A21 ont proposé un algorithme intéressant afin de
calculer le nombre maximal d'étoiles qu'on peut obtenir dans un jeu bien conçu.
