...
***Proposition A.*** *Soient _x_ un élément et _i_ une position de _s_. Soit _s'_ la séquence obtenue en corrigeant _(i, i+1)_ au besoin dans _s_.
Soit _s''_ la séquence obtenue en corrigeant _(i, i+1)_ au besoin dans _fₓ(s)_. Nous avons _s'' = fₓ(s')_.*

***Corollaire B.*** *Soit _s'_ la séquence obtenue après l'exécution de _k_ passes sur _s_, et soit _s''_ la séquence
obtenue après l'exécution de _k_ passes sur _fₓ(s)_. Nous avons _fₓ(s') = s''_.*

***Proposition C.*** *Sur entrée _fₓ(s)_, au début de la passe _i+1_, les _i_ occurrences de `2` les plus à droite sont progressives.*
...
***Proposition D.*** *La séquence _fₓ(s)_ est triée en au plus _2n_ passes.*

*Démonstration.* Soit _k_ la quantité de `2`. Par la proposition A, au début de la passe _k+1_, tous les `2` sont
...
***Proposition E.*** *Soit _x_ un élément de _s_. Si l'algorithme, sur entrée _fₓ(s)_, termine en _k_ passes, alors l'algorithme,
...
et _s''_ les séquences obtenues après _k_ passes des deux exécutions respectives. Par le corollaire B, nous avons _fₓ(s') = s''_.
...
*Démonstration.* Soit _x_ un élément de _s_. Par la proposition D, la séquence _fₓ(s)_ est triée en au plus _2n_ passes.
Par la proposition E, cela signifie que, sur entrée _s_, l'algorithme fixe _x_ en au plus _2n_ passes. □

## Détails

***Proposition.*** *Si _a ≤ b_, alors _fₓ(a) ≤ fₓ(b)_.*
